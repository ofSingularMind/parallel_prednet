...
DATA_DIR = '/scratch/aledbetter/monkaa_data/'
...
WEIGHTS_DIR = '/scratch/aledbetter/model_data_keras2/'

# Where results (prediction plots and evaluation file) will be saved.
RESULTS_SAVE_DIR = '/scratch/aledbetter/monkaa_results/'

# Where Tensorboard logs will be saved if you run kitti_train.py
LOG_DIR = '/scratch/aledbetter/logs/'
