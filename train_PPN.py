...
if __name__ == "__main__":
    ...
    parser.add_argument("--sequences_per_epoch_train", type=int, default=20, help="number of sequences per epoch for training, otherwise default to dataset size / batch size if None")
